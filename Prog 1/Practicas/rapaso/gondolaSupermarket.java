public class gondolaSupermarket {
    ...
    public static void main(String[] args) {
        ...
        int invertidas=0, invertidasTotal=0;

        for(int i=0; i<MAXF; i++){
            invertidas=procesarFila(matriz[i]);
            invertidasTotal+=invertidas;
        }
        
        System.out.println("se ordenaron " + invertidasTotal + " estantes");
    ...
    public static boolean esDes(int[] arr, int ini, int fin){

...
// 1. Instanciamos a las personas que van a participar
    ...
    */
    ...
    Reunion r1 = new Reunion(LocalDate.of(2026, 8, 19), LocalTime.of(16, 00), LocalTime.of(18,00), p1, 2);


    Reunion r2 = new Reunion(LocalDate.of(2026, 8, 19), LocalTime.of(16, 00), LocalTime.of(18,00), p1, 2);

...
void main(String[] args) {
    ...
    Empleado em1 = new Empleado("mariano");
    Empleado em2 = new Empleado("pepe");
    Empleado em3 = new Empleado("peron");
    ...
    empresa.agregarEncuesta(en1);
    empresa.agregarEncuesta(en2);
    empresa.agregarEncuesta(en3);
    empresa.agregarEncuesta(en4);
    empresa.agregarEncuesta(en5);
    empresa.agregarEncuesta(en6);
